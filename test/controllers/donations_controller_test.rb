...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { amount: @donation.amount, comments: @donation.comments, internal_notes: @donation.internal_notes, user_id: @donation.user_id }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { amount: @donation.amount, comments: @donation.comments, internal_notes: @donation.internal_notes, user_id: @donation.user_id }
    assert_redirected_to donation_path(assigns(:donation))
  end
